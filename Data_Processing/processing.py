...
class Preprocessor:
    ...
    def impute_missing_values(self, data, cols_with_missing_values):
        ...
        Description: This method replaces all the missing values in the Dataframe using SimpleImputer.
    ...
    def scale_numerical_columns(self, data):
        ...
        Output: A dataframe with scaled numerical columns
        """
    ...
    def handle_imbalanced_dataset(self, x, y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, 'Exception occurred in handle_imbalanced_dataset method of the Preprocessor class. Exception message:  ' + str(e))
